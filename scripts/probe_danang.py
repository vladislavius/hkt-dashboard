"""Разведка сайтов Da Nang International Airport — ловим XHR endpoint'ы рейсов.

Запуск:  python3 scripts/probe_danang.py

Цель: найти URL и формат ответа API, отдающего таблицу рейсов DAD (Da Nang, VVDN).
По образцу probe_camranh.py.
"""
from playwright.sync_api import sync_playwright

URLS = [
    "https://danangairport.vn/",
    "https://danangairport.vn/flights-flight-status-arrival",
    "https://danangairport.vn/flights-flight-status-departure",
]
